...
@if (Session::has('success'))
    ...
    <div class="artikel">
        ...
        <table class="table">
            ...
            @foreach ($cartItems as $order_item)
                ...
                <tr>
                    ...
                    <td>
                        <a href="/item/cart/delete/{{$order_item->id}}" class="btn btn-danger">
        ...
        <form class="p-5" action="{{route('checkoutItem')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label>Alamat Pengiriman</label>
                <br>
                <textarea rows='10' cols='60' placeholder="Tulis Alamat Pengiriman disini!" name="alamat"></textarea>
            </div>
